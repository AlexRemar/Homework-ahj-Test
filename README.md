...
#### [![Build status](https://ci.appveyor.com/api/projects/status/xn1u37ta9tmjftpy?svg=true)](https://ci.appveyor.com/project/AlexRemar/Homework-ahj-Test) [[Github Pages](https://AlexRemar.github.io/Homework-ahj-Test/)]

---

Правила сдачи задания:

1. **Важно**: в рамках этого ДЗ можно использовать любой менеджер пакето
